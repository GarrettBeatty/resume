...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Pixar Recruitment team}{Pixar Animation Studios\\1200 Park Ave\\Emeryville, CA}
\date{\today}
\opening{Dear HR Manager,}
\closing{Thank you,}
\enclosure[Attached]{resume and personal statement{}}          % use an optional argument to use a string other than "Enclosure", or redefine \enclname
\makelettertitle
